...
import 'package:food_recipie_app/RecipeView.dart';
import 'package:food_recipie_app/model.dart';
import 'package:food_recipie_app/search.dart';
...
class _HomeState extends State<Home> {
  ...
  getRecipes(String query) async {
    String url =
        "https://api.edamam.com/search?q=$query&app_id=7843a100&app_key=b211282076a01ffcb3eb456fe2fb67d2";
